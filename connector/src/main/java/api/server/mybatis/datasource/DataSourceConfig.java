package api.server.mybatis.datasource;
...
public class DataSourceConfig {
    ...
    public DisabledDataSource disabledDataSource() {
    ...
    public DataSource mysqlDataSource() {
        return createDataSource(
                "DB_LOCAL",
                "jdbc:log4jdbc:mysql://localhost:3306/mydb?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=Asia/Seoul",
                "API(JvV71oWlyNo=)",
