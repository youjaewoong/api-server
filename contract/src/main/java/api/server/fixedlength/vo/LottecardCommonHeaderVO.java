...
public class LottecardCommonHeaderVO implements HeaderType {
     ...
     * </pre>
     */
    @FixedLength(length = 31, offset = 5)
    private String guid ;
     ...
     * </pre>
     */
    @FixedLength(length = 8, offset = 38)
     ...
     * </pre>
     */
    @FixedLength(length = 2, offset = 47)
     ...
     * </pre>
     */
    @FixedLength(length = 17, offset = 49)
     ...
     * </pre>
     */
    @FixedLength(length = 16, offset = 66)
     ...
     * </pre>
     */
    @FixedLength(length = 12, offset = 82)
     ...
     * </pre>
     */
    @FixedLength(length = 9, offset = 94)
     ...
     * </pre>
     */
    @FixedLength(length = 9, offset = 103)
     ...
     * </pre>
     */
    @FixedLength(length = 20, offset = 112)
     ...
     * </pre>
     */
    @FixedLength(length = 1, offset = 132)
     ...
     * </pre>
     */
    @FixedLength(length = 17, offset = 133)
     ...
     * </pre>
     */
    @FixedLength(length = 1, offset = 150)
    private String pcRc ;
     ...
     * </pre>
     */
    @FixedLength(length = 8, offset = 151)
     ...
     * </pre>
     */
    @FixedLength(length = 1, offset = 159)
     ...
     * </pre>
     */
    @FixedLength(length = 40, offset = 160)
