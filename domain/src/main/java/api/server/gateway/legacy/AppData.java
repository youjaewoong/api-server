...
public abstract class AppData extends AbstractData {
    ...
    protected byte[] makeErrData(String errCode, String errMsg, String traceno) {
        ...
        System.arraycopy(appHeader, 0, sendBytes, idx, appHeader.length);
        idx += appHeader.length;
        System.arraycopy(appBody, 0, sendBytes, idx, appBody.length);
        idx += appBody.length;
    ...
    protected byte[] makeHeader(String resCode, int bodyLen) {
        ...
        System.arraycopy(bTot, 0, bHeader, nIdx, 4);
        nIdx += 4;
        System.arraycopy(bTmp, 0, bHeader, nIdx, bTmp.length);
        nIdx += bTmp.length;
