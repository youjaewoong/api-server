...
//	                          }
                ...
                throw new MyException("[KICCWorker::formatData]", MyException.SY21, "Undefined MsgType", MyException.sysErrMsg);
        } catch (Exception e) {
    ...
    private String getField01(int format, String basecurrency, String homecurrency, String mcpYN) {
        switch (format) {
            ...
            case AppData.F0120: //승인(수동매입)
                if (basecurrency.equals("USD") || basecurrency.equals("KRW") || basecurrency.equals("HKD") || basecurrency.equals("THB") || basecurrency.equals("JPY") || basecurrency.equals("CNY"))
                    return "1130";
