...
public class FixedLengthService {
	...
	private static final Map<String, Integer> RESPONSE_FIELD_LENGTHS = new HashMap<>() {{
		put("userName", 10);
		put("email", 20);
		put("cardType", 10);
	}};
    ...
    public Map<String, String> findFixedLengthData(FixedLengthRequest fixedLengthRequest) throws IOException {
		 ...
		 String strFixedLengthRequest = FixedLengthUtil.toFixedLength(fixedLengthRequest.getData(), FIELD_LENGTHS);
